...
El constructor es quien define todo lo principal de la particula y su clase es quien las crea, depues en sketch se recorre estas para saber el estado de estas. Ahora bien, el no reiniciar las particulas le exigirá mucho mas a la CPU para recorrer y leer todas las particulas dadas.
